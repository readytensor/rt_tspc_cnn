# CNN Time Step Classifier in Torch

CNN Time Step Classification Model in Torch as per Ready Tensor specifications.
...
- A **CNN Time Step Classification** model built using **Torch**
